...
//                                         <div className="mt-3">
//                                             {/* <h4>{decode.firstName}</h4> */}
//                                             <h4>name</h4>
//                                             <p className="form-control mb-1">Full Stack Developer</p>
...
//                                             </svg>Website</h6>
//                                         <span className="form-control">https://www.alokknight.com</span>
//                                     </li>
//                                     <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
...
//                                         </svg>Github</h6>
//                                         <span className="form-control">bootdey</span>
//                                     </li>
//                                     <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
...
//                                     </li>
//                                     <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
//                                         <h6 className="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-facebook mr-2 icon-inline text-primary"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
//                                         </svg>Facebook</h6>
//                                         <span className="form-control">bootdey</span>
//                                     </li>
//                                 </ul>
                                ...
                                <div className="profilecard-body">
                                    <div className="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="form-control" >Full Stack Developer</p>
                            ...
                            <div className="profilecard mt-3">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="form-control">{decode.website}</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="form-control">{decode.github}</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="form-control">{decode.twitter}</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="form-control">{decode.instagram}</span>
                                    </li>
                                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span className="form-control">{decode.facebook}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-md-8">
                            <div className="profilecard mb-3">
                                <div className="profilecard-body">
                                    <div className="row">
                                        ...
                                        <div className="form-control" style={{ textDecoration: 'none', color: "black", "text-transform": "uppercase" }}>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            <NavLink className="btn btn-info" to="/saveprofile">Save</NavLink>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="profilecard mb-3">
                                <div className="profilecard-body">
                                    <div className="row">
                                        <div className="col-sm-3">
                                            <h4 className="mb-0" style={{ color: "black" }}><strong>MY LATEST EVENTS</strong></h4>
                                        </div>
                                    </div>
                                    <hr />
                                        ...
                                        events.map(event => {
                                            return (
                                                <div key={event._id} className="p-3 mb-2 text-black">
                                                    <Link style={{ textDecoration: 'none', color: "black", "text-transform": "uppercase" }} to={`/event/${event.eName}`}>
                            ...
                            <div className="row gutters-sm">
                                    ...
                                    <div className="profilecard h-100">
                                        <div className="profilecard-body">
                                            <h6 className="d-flex align-items-center mb-3">
                                                <i className="material-icons text-info mr-2">MY PAST EVENTS</i>
                                            </h6>
                                            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                <NavLink className="mb-0" to="/#" style={{ textDecoration: 'none', color: "blue" }}>
                                                    Event2
                                                </NavLink>
                                                <span className="text-secondary">Date nd time</span>
                                            </li>
                                ...
                                <div className="progress-bar bg-primary" role="progressbar" style={{width: '66%'}} ></div>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <NavLink className="btn btn-info" to="/updateprofile">All Events</NavLink>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="col-sm-6 mb-3">
                                    <div className="profilecard h-100">
                                        <div className="profilecard-body">
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <NavLink className="btn btn-info" to="/likedevent">All Liked</NavLink>
                                                </div>
                                            </div>
